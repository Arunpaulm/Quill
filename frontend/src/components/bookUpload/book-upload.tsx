...
const BookUpload: React.FC = () => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (!file) {
            ...
            baseURL.post('/books/upload', formData, authHeaders).then(response => {
                    ...
                    <div className="space-y-12">
                        <div className="pb-2">
                            <div className="grid items-center justify-center">
                                <h1 className="text-base font-bold leading-7 text-gray-900 mx-auto">Upload an E-Book</h1>
                            ...
                            <div className="col-span-full mt-4">
                                ...
                                <div className="flex items-center justify-center w-full mt-2">
                                    <label className="flex flex-col items-center justify-center w-full h-55 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                        ...
                                        <input id="dropzone-file" type="file" className="hidden" onClick={handleFileInputClick} onChange={handleFileChange} />
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="border-b border-gray-900/10 pb-12">
                            <div className="grid items-center justify-center">
                                <h2 className="text-base font-semibold leading-7 text-gray-900 mx-auto">Basic Information</h2>
                                <p className="mt-1 text-sm leading-6 text-gray-600">Details about the book. Be specific!</p>
                            </div>
                                ...
                                <div className="col-span-full">
                                    ...
                                    <div className="mt-2">
                                        <input type="text" id="description" name="description"
                                            autoComplete="description" className="block w-full p-6 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                    </div>
                                </div>
                            </div>
                        </div>
