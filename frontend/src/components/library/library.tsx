...
import { Item } from '../explore/explore'; import image1 from "../../assets/books/image/thought-catalog-OJZB0VUQKKc-unsplash.jpg";
          ...
          <div className="w-1/4 mt-5 flex" key={item.id}>
            <div className="rounded-lg border-0 border-gray-200 max-w-sm bg-white shadow dark:bg-gray-800 dark:border-gray-700 m-2">
              ...
              <div className="px-5 pb-5">
                ...
                <div className="mt-4">
                  <a href={item.url} target='_blank' className="mx-6 text-white bg-red-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">View</a>
                </div>
              </div>
            </div>
          </div>
