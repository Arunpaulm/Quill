...
const storage = new storage_1.Storage({
    ...
    keyFilename: path_1.default.join(__dirname, "../../config/trusty-matrix-415912-1569b01bf45e.json"), // Provide the path to your service account key
});
...
const uploadFile = async (req, res) => {
    ...
    try {
        ...
        const newFile = new bookModel_1.Book({
            ...
            uploadedBy: (_c = req === null || req === void 0 ? void 0 : req.body) === null || _c === void 0 ? void 0 : _c.uploadedBy,
            description: (_d = req === null || req === void 0 ? void 0 : req.body) === null || _d === void 0 ? void 0 : _d.description
        });
